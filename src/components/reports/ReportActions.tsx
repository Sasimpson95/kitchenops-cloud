...
export default function ReportActions({ onCsv, onPrint }: ReportActionsProps) {
  return (
    <div className="flex flex-wrap gap-3 print:hidden">
      <button type="button" onClick={onCsv} className="inline-flex items-center gap-2 rounded-xl bg-violet-800 px-4 py-2 font-semibold text-white hover:bg-violet-900">
