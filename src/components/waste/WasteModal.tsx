...
export default function WasteModal({
  ...
  return (
    ...
    >
      <div
        data-mobile-sheet="true" role="dialog" aria-modal="true" className="mobile-native-sheet max-h-[94vh] w-full max-w-4xl overflow-y-auto rounded-2xl bg-white p-8 shadow-2xl"
      ...
      >
        ...
        <div className="mobile-sticky-actions mt-8 flex flex-col-reverse gap-3 border-t pt-6 sm:flex-row sm:justify-end">
          <button
            type="button"
            onClick={onClose}
