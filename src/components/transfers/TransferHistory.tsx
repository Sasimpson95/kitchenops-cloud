...
export default function TransferHistory({ transfers, currentUser, onChanged }: TransferHistoryProps) {
  if (transfers.length === 0) {
    return <div className="rounded-2xl bg-white p-12 text-center shadow-sm"><PackageSearch size={38} className="mx-auto text-gray-400"/><h2 className="mt-4 text-2xl font-bold text-gray-950">No transfers recorded</h2><p className="mt-2 text-gray-500">Requested, dispatched and received transfers will appear here.</p></div>;
  }
